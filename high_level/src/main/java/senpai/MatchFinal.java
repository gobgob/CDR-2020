...
public class MatchFinal
{
	...
	public void exec(String configFile) throws InterruptedException
	{
		...
		table.setDone(AtomeParTerre.HAUT_DROITE);
		table.setDone(AtomeParTerre.MILIEU_DROITE);
		table.setDone(AtomeParTerre.HAUT_GAUCHE);
		table.setDone(AtomeParTerre.MILIEU_GAUCHE);
