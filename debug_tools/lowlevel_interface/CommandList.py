...
Command(0x88, "Parking break", CommandType.SHORT_ORDER, [Field("Enable", bool)], []),
...
Command(0x96, "Set max speed",          CommandType.SHORT_ORDER, [Field("Speed", float, description="mm/s")], []),
Command(0x97, "Set aim distance",       CommandType.SHORT_ORDER, [Field("Distance", float, description="mm")], []),
Command(0x98, "Set curvature",          CommandType.SHORT_ORDER, [Field("Curvature", float, description="m^-1")], []),
Command(0x99, "Set direction angle",    CommandType.SHORT_ORDER, [Field("Angle", int, description="deg")], []),
...
Command(0x9D, "Set max acceleration",   CommandType.SHORT_ORDER, [Field("Acceleration", float, description="mm.s^-2")], []),
Command(0x9E, "Set max deceleration",   CommandType.SHORT_ORDER, [Field("Deceleration", float, description="mm.s^-2")], []),
Command(0x9F, "Set max curvature",      CommandType.SHORT_ORDER, [Field("Curvature", float, description="m^-1")], []),
